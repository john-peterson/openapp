...
# javac -Xmaxerrs 1 -Xlint:-options -Xlint:-deprecation -target $jdk -source $jdk -classpath $jar -d obj Main.java
# javac -Xmaxerrs 1 -Xlint:none  -target $jdk -source $jdk -classpath $jar -d obj Main.java
javac -Xmaxerrs 1 -Xlint:none  -target $jdk -source $jdk -bootclasspath $JAVA_HOME/jre/lib/rt.jar -classpath $jar -d obj *.java
# javac -Xmaxerrs 1 -Xlint:none  -target $jdk -source $jdk -classpath $jar -d obj *.java
